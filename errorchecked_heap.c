...
void *errorchecked_malloc(unsigned int); // Function prototype for errorchecked_malloc() This lets the compiler know that there will be a function called errorchecked_malloc that will accept one positive number and will return a void pointer
